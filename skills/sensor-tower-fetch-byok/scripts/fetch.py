...
套可选口径（query.json 的 caliber: net=ST原始净收入不÷0.7 / gross=÷0.7还原毛支出；CN上修默认关），重算 RPD/ARPDAU，出多 sheet Excel。不依赖其它 skill。口径见 03_数据源/SensorTower/数据口径说明.md。
...
# CN 区上修默认关闭(CN_*_MULT=1.0); 如需开启改下方常量。详见 03_数据源/SensorTower/数据口径说明.md
CN_CODES = {"CN"}
